  ...
  return (
    <div style={{ fontFamily: 'Heebo, sans-serif', maxWidth: '580px', margin: '0 auto', padding: '20px 0' }}>
      ...
      <div className="section-anim" style={{ textAlign: 'center', marginBottom: '36px' }}>
        ...
        <h1 style={{
          fontSize: '32px', fontWeight: '900', color: 'var(--text)',
          letterSpacing: '-0.03em', margin: '0 0 10px', lineHeight: 1.15,
        }}>
          {language === 'he' ? 'שדרג ל' : 'Upgrade to '}
          <span style={{ color: '#f59e0b' }}>PRO</span>
        </h1>
        <p style={{ fontSize: '14px', color: 'var(--text3)', fontWeight: '500', margin: 0, lineHeight: 1.6 }}>
          {language === 'he'
      ...
      <div className="section-anim anim-delay-1" style={{
        ...
        <div style={{ textAlign: 'center', marginBottom: '28px', position: 'relative' }}>
          <div style={{ display: 'inline-flex', alignItems: 'center', gap: '6px', background: 'rgba(245,158,11,0.12)', border: '1px solid rgba(245,158,11,0.25)', borderRadius: '999px', padding: '5px 14px', marginBottom: '16px' }}>
            ...
            <span style={{ fontSize: '11px', fontWeight: '800', color: '#f59e0b', letterSpacing: '0.1em', textTransform: 'uppercase' }}>
              {language === 'he' ? 'מנוי פרימיום' : 'Premium Plan'}
            </span>
          </div>
          <div style={{ display: 'flex', alignItems: 'flex-end', justifyContent: 'center', gap: '4px' }}>
            <span style={{ fontSize: '52px', fontWeight: '900', color: 'var(--text)', letterSpacing: '-0.04em', lineHeight: 1 }}>$20</span>
            <span style={{ fontSize: '14px', color: 'var(--text3)', fontWeight: '600', paddingBottom: '10px' }}>
        ...
        <div style={{
          ...
          {proList.map((f, i) => (
            <div key={i} style={{
              ...
              <span style={{ fontSize: '12px', color: 'var(--text2)', fontWeight: '600' }}>{f.label}</span>
            </div>
          ))}
        </div>
      ...
      <div className="section-anim anim-delay-3" style={{
        ...
        {[
          ...
          { icon: 'cancel', label: language === 'he' ? 'ביטול בכל עת' : 'Cancel Anytime', color: '#3b82f6' },
        ].map((badge, i) => (
          <div key={i} style={{
            ...
            <div style={{ fontSize: '11px', fontWeight: '700', color: 'var(--text2)' }}>{badge.label}</div>
          </div>
        ))}
      </div>
