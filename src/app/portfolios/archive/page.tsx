                        ...
                        <>
                          ...
                          {trades.map((trade, idx) => (
                            ...
                            >
                              ...
                              {/* RR */}
                              <div className="trade-col-rr" dir="ltr" style={{ textAlign: 'center', fontSize: '13px', fontWeight: '800', color: trade.outcome === 'win' && trade.rr_ratio != null ? '#22c55e' : 'var(--text3)' }}>{trade.outcome === 'win' && trade.rr_ratio != null ? `1 : ${trade.rr_ratio.toFixed(1)}` : '—'}</div>
