    ...
    return (
      <div style={{ fontFamily: 'Heebo, sans-serif' }}>
        ...
        <div style={{ textAlign: 'center', padding: '80px 20px' }}>
          ...
          <div style={{ fontSize: '22px', fontWeight: '600', color: 'var(--text)', marginBottom: '12px' }}>
          ...
          <Link href="/upgrade" style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', background: '#f59e0b', color: '#fff', padding: '12px 28px', borderRadius: '12px', textDecoration: 'none', fontSize: '14px', fontWeight: '600' }}>
    ...
    return (
      <div style={{ fontFamily: 'Heebo, sans-serif' }}>
        ...
        <div style={{ textAlign: 'center', padding: '80px 20px' }}>
          ...
          <div style={{ fontSize: '20px', fontWeight: '600', marginBottom: '10px', color: 'var(--text)' }}>
          ...
          <button onClick={() => { localStorage.setItem('tradeix-open-new-portfolio', '1'); router.push('/portfolios') }} style={{ background: '#10b981', color: '#fff', padding: '12px 28px', borderRadius: '12px', border: 'none', fontSize: '13px', fontWeight: '600', cursor: 'pointer', fontFamily: 'Heebo, sans-serif' }}>
  ...
  return (
    <div style={{ fontFamily: 'Heebo, sans-serif' }}>
      ...
      <style>{`
        ...
        .cal-day { font-size: 12px; font-weight: 600; line-height: 1; margin-bottom: 4px; align-self: flex-start; padding-inline-start: 2px; }
        .cal-body { flex: 1; display: flex; flex-direction: column; align-items: center; justify-content: center; gap: 3px; }
        .cal-pnl { font-size: 14px; font-weight: 700; letter-spacing: -0.02em; line-height: 1; text-align: center; }
        .cal-wr { font-size: 9px; font-weight: 600; text-align: center; letter-spacing: 0.04em; }
        @media (max-width: 640px) {
          .cal-wrap { padding: 14px !important; }
          .cal-grid { gap: 4px; }
          .cal-cell { min-height: 68px; border-radius: 10px; padding: 5px 4px; }
          .cal-day { font-size: 10px; } .cal-pnl { font-size: 11px; } .cal-wr { font-size: 8px; }
        ...
        @media (max-width: 400px) {
          ...
          .cal-day { font-size: 9px; } .cal-pnl { font-size: 10px; } .cal-wr { font-size: 8px; }
