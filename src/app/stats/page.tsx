    ...
    return (
      <div style={{ fontFamily: 'Heebo, sans-serif' }}>
        ...
        <div style={{ textAlign: 'center', padding: '80px 20px' }}>
          ...
          <button onClick={() => { localStorage.setItem('tradeix-open-new-portfolio', '1'); router.push('/settings?section=portfolios') }} style={{ background: '#0f8d63', color: '#fff', padding: '12px 28px', borderRadius: '12px', border: 'none', fontSize: '14px', fontWeight: '600', cursor: 'pointer', fontFamily: 'Heebo, sans-serif' }}>
